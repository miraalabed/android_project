...
public class AddTeacherActivity extends AppCompatActivity {
    ...
    String insertUrl = "http://10.0.2.2/api/add_teacher.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.d("AddTeacherActivity", "Page opened successfully");
        ...
        btnAddteacher.setOnClickListener(view -> {
    ...
    private boolean validateAllFields() {
        ...
        if (birthDate.isEmpty()) {
            ...
            editBirthDate.setError("Age must be between 24 and 60 years");
            valid = false;
        }
    ...
    private void addteacherToDatabase() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl,
                ...
                error -> Toast.makeText(AddTeacherActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_LONG).show()) {
